...
{
    class MefeteTransferMefeteAccountMap : ClassMap<NW.Core.Entities.Payment.MefeteTransferMefeteAccount>
    {
        public MefeteTransferMefeteAccountMap()
        {
            Id(x => x.Id);
            Map(x => x.StatusType);
            Map(x => x.CreateDate);
