...
{
    class PEPTransferPEPAccountMap : ClassMap<NW.Core.Entities.Payment.PEPTransferPEPAccount>
    {
        public PEPTransferPEPAccountMap()
        {
            Id(x => x.Id);
            Map(x => x.StatusType);
            Map(x => x.CreateDate);
