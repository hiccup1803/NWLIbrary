...
{
    class CMTTransferCMTAccountMap : ClassMap<NW.Core.Entities.Payment.CMTTransferCMTAccount>
    {
        public CMTTransferCMTAccountMap()
        {
            Id(x => x.Id);
            Map(x => x.StatusType);
            Map(x => x.CreateDate);
