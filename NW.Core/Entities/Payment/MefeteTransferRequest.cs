...
{
    public class MefeteTransferRequest : Entity<int>
    {
        public virtual int PaymentStatusType { get; set; }
        public virtual int MefeteTransferMefeteAccountId { get; set; }
        ...
        public virtual MefeteTransferMefeteAccount MefeteTransferMefeteAccount { get; set; }
    }
}
