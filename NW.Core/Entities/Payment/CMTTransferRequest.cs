...
{
    public class CMTTransferRequest : Entity<int>
    {
        public virtual int PaymentStatusType { get; set; }
        public virtual int CMTTransferCMTAccountId { get; set; }
        ...
        public virtual CMTTransferCMTAccount CMTTransferCMTAccount { get; set; }
    }
}
