...
{
    public class ParazulaTransferRequest : Entity<int>
    {
        public virtual int PaymentStatusType { get; set; }
        public virtual int ParazulaTransferParazulaAccountId { get; set; }
        ...
        public virtual ParazulaTransferParazulaAccount ParazulaTransferParazulaAccount { get; set; }
    }
}
