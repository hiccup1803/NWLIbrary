...
{
    public class PaparaTransferRequest : Entity<int>
    {
        public virtual int PaymentStatusType { get; set; }
        public virtual int PaparaTransferPaparaAccountId { get; set; }
        ...
        public virtual PaparaTransferPaparaAccount PaparaTransferPaparaAccount { get; set; }
    }
}
